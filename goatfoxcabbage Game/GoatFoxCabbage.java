...
public class GoatFoxCabbage
{
	...
	*/
		...
		String answer = screenUserInput(keyboard);
		change(answer);
		return true;
	}
	...
	*/
	...
	/*
	*@param keyboard input that determines what the person would like to move
	*This function checks if the input is good
	*/
	{
		...
		else if(!input.equals("C") && !input.equals("H") && !input.equals("F") && !input.equals("G"))
		{
			System.out.println("Only C,H,F,G are valid inputs");
			return screenUserInput(kb);
		return input;
